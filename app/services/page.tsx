        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-teal-50 rounded-3xl p-10 sm:p-14 border border-teal-100 mb-20">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                { title: 'Professional Supplies', desc: 'Hospital-grade disinfectant, HEPA vacuums, microfiber cloths, eco-friendly products.', icon: '🧴' },
                { title: 'Full Insurance', desc: '$2M general liability. Your property is protected against any incident or damage.', icon: '🛡' },
                { title: 'Photo Documentation', desc: 'Before/after photos emailed to you after every cleaning for remote verification.', icon: '📸' },
                { title: 'Satisfaction Guarantee', desc: 'Not happy? We re-clean for free. No questions asked. 100% money-back guarantee.', icon: '⭐' },
              ].map((item, i) => (
